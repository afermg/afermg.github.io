...
* DONE Duckdb for the MBTA public dataset :duckdb:data-science:@workflow:opendata:
...
#+begin_src sql :session test_session :db test.duckdb :exports both :tangle duckdb_mbta.sql
  .maxrows 11
...
#+begin_src sql :session test_session :db test.duckdb :exports both :tangle duckdb_mbta.sql :wrap example
...
│      varchar      │         varchar[]         │       int32       │
├───────────────────┼───────────────────────────┼───────────────────┤
│ North Station     │ [Green Line, Orange Line] │             11315 │
│ South Station     │ [Silver Line, Red Line]   │             10342 │
│ Harvard           │ [Red Line]                │              9691 │
│ Downtown Crossing │ [Orange Line, Red Line]   │              9492 │
