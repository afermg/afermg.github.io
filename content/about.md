...
Outside work, I enjoy multi-day hikes, bikepacking trips and, more recently, I got into board games (especially worker placement/engine building such as [Wingspan](https://boardgamegeek.com/boardgame/266192/wingspan) or [Yokohama](https://boardgamegeek.com/boardgame/196340/yokohama)).


# Current projects

-   [cp\_measure](https://github.com/afermg/cp_measure): Featurise objects from images and masks (microscopy or otherwise).
-   [nahual](github.com/afermg/nahual): Transfer data between running Python instances for dependency-free deployment of complex models and algorithms (mostly deep learning models).
...
-   [Nix Config](https://github.com/afermg/nix-configs): Fully reproducible computing environments for both multi-user workstations/servers and my Macbook.
